...
Hint to full-stack integration guide

- Meta frameworks that are "just Vite plugins":
...
### Unsupported Meta Frameworks

- Next.js
- No Vite integration -> TL;DR why not
...
- [Rails](https://vite-ruby.netlify.app/)
